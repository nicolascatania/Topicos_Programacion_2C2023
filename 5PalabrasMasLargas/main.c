...
int main()
{
    ...
    //obtener5FrasesMasLargasMatriz();

    //obtenerNiniciales... tiene bastantes cosas por mejorar, como el recorrer vector, podria usar uno generico y listo.

    /*int inicialesAObtener=5;
    printf("%d frases mas largas\n",inicialesAObtener);
    obtenerNInicialesConMasApariciones(inicialesAObtener);*/

    mostrarFrasesConPalabrasCoincidentes();
